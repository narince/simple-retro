        ...
        <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="touch-none select-none relative group mb-3">
            ...
            >
                ...
                <CardFooter className="p-0 pt-2 flex justify-between items-center text-xs text-white/90 mt-1">
                    ...
                    <div
                        className="flex items-center gap-1 opacity-70 p-1 rounded-sm"
                    >
                ...
                <div className="mt-3 pt-3 border-t border-white/20" onPointerDown={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex items-center gap-2" onPointerDown={(e) => e.stopPropagation()}>
                            <div className="relative flex-1">
                                ...
                                {commentMentionQuery !== null && filteredMentionMembers.length > 0 && (
                                    <div className="absolute top-full left-0 mt-1 w-52 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-lg shadow-xl z-[200] overflow-hidden">
